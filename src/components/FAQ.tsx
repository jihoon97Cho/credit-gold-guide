...
const faqs = [
  ...
  { q: "What if nothing gets removed?", a: "We offer a money-back guarantee. If we cannot remove at least one negative item within the first 30–60 days, you get your money back. No questions asked." },
